...
#ALCOHOL VS POPULATION
    ...
    dp.save_results("Correlation between population and number of alcohol selling companies", corr_alc_vs_pop, os.path.join(output_dir, "Corr_alcohol_vs_population.txt"))
...
#FIRE INCIDENTS VS ALCOHOL 
    ...
    dp.save_results("Correlation between number of all fire incidents and number of alcohol selling companies", corr_all_fire_vs_alc, os.path.join(output_dir, "Corr_all_fire_vs_alcohol.txt"))
    dp.save_results("Correlation between number of actual fire incidents and number of alcohol selling companies", corr_actual_fire_vs_alc, os.path.join(output_dir, "Corr_actual_fire_vs_alcohol.txt"))
    dp.save_results("Correlation between number of false reports of fire incidents and number of alcohol selling companies", corr_false_fire_vs_alc, os.path.join(output_dir, "Corr_fake_fire_vs_alcohol.txt"))
...
#FIRE INCIDENTS VS POPULATION
    ...
    dp.save_results("Correlation between number of all fire incidents and population", corr_all_fire_vs_pop, os.path.join(output_dir, "Corr_all_fire_vs_population.txt"))
    dp.save_results("Correlation between number of actual fire incidents and population", corr_actual_fire_vs_pop, os.path.join(output_dir, "Corr_actual_fire_vs_population.txt"))
    dp.save_results("Correlation between number of false reports of fire incidents and population", corr_false_fire_vs_pop, os.path.join(output_dir, "Corr_fake_fire_vs_population.txt"))
...
#FIRE INCIDENTS VS AREA
    ...
    dp.save_results("Correlation between number of all fire incidents and area", corr_all_fire_vs_area, os.path.join(output_dir, "Corr_all_fire_vs_area.txt"))
    dp.save_results("Correlation between number of actual fire incidents and area", corr_actual_fire_vs_area, os.path.join(output_dir, "Corr_actual_fire_vs_area.txt"))
    dp.save_results("Correlation between number of false reports of fire incidents and area", corr_false_fire_vs_area, os.path.join(output_dir, "Corr_fake_fire_vs_area.txt"))
